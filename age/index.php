  ...
  <div class="box2">
    <div class="start-up" id="start-up">
      <div class="logo">
        ...
        <h2 class="start-up-text">e.n.c <span>age calculator</span></h2>
        <div class="loader" id="loader">
          <p>opening age Checker </p>
    ...
    <div class="moduleBox age-box">
      <div class="moduleBox contentBox">
        <div class="title text">
          <h3>e.n.c age calculator</h3>
          <p id="age-msg"></p>
        </div>
        <div class="box">
          <div class="input-box col">
            <input type="number" id="dob" placeholder="Your Date of Birth..">
            <input type="number" id="curry" placeholder="The Current Year..">
          </div>
        </div>
        <button type="button" class="hero-btn width" onclick="addAge()">get result</button>
      </div>
    </div>
  </div>
