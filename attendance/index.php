  ...
  <div class="box2">
    <div class="start-up" id="start-up">
      <div class="logo">
        ...
        <h2 class="start-up-text">e.n.c <span>lectures attendance</span></h2>
        <div class="loader" id="loader">
          <p>opening lectures attendance </p>
        ...
        <form id="chapel" method="post">
          <div class="box">
            <div class="input-box col">
              ...
              <input type="text" id="module" placeholder="Your Module.." name="module" autocomplete="off" required>
              <input type="text" id="lecturer_code" placeholder="Lecturer Class Code.." name="lecturer_code" autocomplete="off" required>
