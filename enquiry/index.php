  ...
  <div class="box2">
    <div class="start-up" id="start-up">
      <div class="logo">
        ...
        <h2 class="start-up-text">e.n.c <span>enquiry</span></h2>
    ...
    <div class="container">
      <div class="flexBox">
        ...
        <form id="form" method="post">
          <input type="text" value="john" name="user">
          <input type="number" value="1234" name="pass">
          <input type="text" name="dept" value="bit">
          <textarea name="msg" placeholder="Hey, my name is john, my problem is?..."></textarea>
          <button type="button" class="hero-btn">send enquiry</button>
        </form>
      </div>
    </div>
  </div>
